...
| 2026-08-19 | James Kevin Ty outreach | Invite a Philippines-based smart-telescope/lunar imager to private alpha | Closed | Doug sent a one-to-one message after seeing James's lunar imaging work from Manila, Philippines. The candidate was Android-only, and Doug accidentally described Polaris as iOS-only even though it is a browser-based web app. | Medium | Treat as invitation-language evidence. Future invites must say Polaris is a private browser-based web app best tested on desktop/laptop browser, not iOS-only or Android-only. |
| 2026-08-19 | Luigi Gallo outreach | Invite an Italy-based deep-sky imager to private alpha | Invited | Luigi posted a Dark Shark Nebula image and explained that he had to reach a Bortle 5 sky in Sicily because Rome's Bortle 7/8 light pollution made it hard to get a clear signal even after long integration. | Low | If interested, collect setup email, approximate observing region, rig, and tracking style. His feedback is useful for light-pollution/site-choice reasoning, non-US weather, and whether Polaris helps with the decision to image locally versus travel to darker skies. |
| 2026-08-19 | Bill Wathier outreach | Invite a US-based DWARF 3 user to private alpha | Invited | Bill posted a North America Nebula mosaic from Bortle 4 skies using the DWARF 3 schedule feature and said he is still learning it, though it seems easier than he is making it. | Low | If interested, collect setup email, approximate observing region, rig, and tracking style. His feedback is useful for beginner-to-intermediate schedule clarity, DWARF 3 mosaic/framing expectations, and a US weather/location baseline. |
